  ...
  var demoHighCharts = function() {
    ...
    var demoHighBars = function() {
      ...
      if (bars1.length) {
        ...
        // Bar Chart 1
        bars1.highcharts({
          colors: [bgPrimary, "#35a7ff", "#377fbe", bgWarning,
            bgDanger, bgSuccess, bgSystem, bgDark
          ],
          credits: false,
          legend: {
  ...
  var demoCircleGraphs = function() {
    ...
    if (infoCircle.length) {
      ...
      var colors = {
        ...
        "alert": [bgAlert, bgAlertLr, bgAlertDr],
        "default": ["#35a7ff", "#35a7ff", "#35a7ff"],
        "boston": ["#377fbe", "#377fbe", "#377fbe"]
      };
      // Store all circles
      var circles = [];
      infoCircle.each(function(i, e) {
        // Define default color
        var color = ['#fafafa', bgPrimary];
        // Modify color if user has defined one
        var targetColor = $(e).data(
            'circle-color');
        if (targetColor) {
          var color = ['#fafafa', colors[
              targetColor][0]]
        }
        // Create all circles
